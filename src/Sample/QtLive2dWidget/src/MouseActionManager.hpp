...
public:
  ...
  * @param[in]       modify
  */
  void OnMouseCallBack(QLive2dWidget* window, int button, int action, int modify);
  ...
  * @param[in]       y                 x座標
  */
  void OnMouseCallBack(QLive2dWidget* window, double x, double y);
...
public:
    ...
    */
    static void OnMouseCallBack(QLive2dWidget* window, double x, double y)
    {
