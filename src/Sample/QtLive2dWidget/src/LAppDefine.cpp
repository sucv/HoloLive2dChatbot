...
#include "LAppGetModelFolders.hpp"
...
//    };
    ...
    std::vector<const char*> ModelDir = getFileNamesFromDir(ResourcesPath);
//    const csmInt32 ModelDirSize = sizeof(ModelDir) / sizeof(const char*);
    const size_t ModelDirSize = ModelDir.size();
